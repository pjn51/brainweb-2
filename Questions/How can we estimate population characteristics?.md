*How can we estimate population characteristics?* When attempting to understand the nature of populations, we cannot hope to examine each individual. Therefore, we must rely on a *sample* of the population.
