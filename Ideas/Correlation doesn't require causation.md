*Correlation doesn't require causation.* We cannot infer causal relationships between variables just based on the fact that they are associated with one another.
